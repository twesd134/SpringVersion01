...
public class BoardControllerImpl  implements BoardController{
	...
	HttpServletResponse response) throws Exception {
		...
		//글 정보를 저장하기 위한 articleMap을 생성합니다.
		Enumeration enu=multipartRequest.getParameterNames();
		while(enu.hasMoreElements()){
			String name=(String)enu.nextElement();
			String value=multipartRequest.getParameter(name);
			articleMap.put(name,value);
		} //글쓰기창에서 전송한 글 정보를 Map에 Kye/value로 저장
...
//	int parentNO=Integer.parseInt(multipartRequest.getParameter("parentNO"));
//	HttpSession session = multipartRequest.getSession();
...
//	session.setAttribute("parentNO",parentNO);
	...
	private ModelAndView reform(HttpServletRequest request,HttpServletResponse response) throws Exception {
		String viewName = (String)request.getAttribute("viewName");
